...
import 'diesel_details.dart';
import 'driver_analysis.dart';
import 'vehicle_analysis.dart';
import 'vehicle_events.dart';
import 'driver_management.dart';
import 'vehicle_management.dart';
import 'staff_management.dart';
import 'logbook_admin_screen.dart';
...
class _DirectorDashboardState extends State<DirectorDashboard> {
  ...
  Widget _getScreen(int index) {
    switch (index) {
      ...
      case 8:
        return StaffManagementScreen(supabaseService: widget.supabaseService);
      case 9:
            ...
            DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.authService.currentUser?.name ?? _loc.t('director'),
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              '${_loc.t('welcome')}, ${_loc.t('director')}',
              style: const TextStyle(
                fontSize: 22,
                fontWeight: FontWeight.bold,
